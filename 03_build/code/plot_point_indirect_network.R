## --------------------------------------------------
## dataのインポート
point_data_raw <- read.csv("02_raw/data/point_indirect.csv",header=T)
...
## --------------------------------------------------
## plot
graph_indirect <- graph_from_data_frame(point, directed = T)
...
plot(
  graph_indirect,
  vertex.size = graph.pr_indirect$vector*80, #ノードの大きさ
